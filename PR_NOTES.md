...
- Updated metadata accuracy: `role_name: ssh`, restored Archlinux platform entry, noted EL remains at upstream’s `7` (ansible-lint schema will complain; adjust to a specific minor or `all` if upstream prefers).
